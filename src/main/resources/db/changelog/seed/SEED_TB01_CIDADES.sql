...
VALUES ('Alta Floresta D''Oeste', '1100015', 'RO'),
       ...
       ('Nova Brasilândia D''Oeste', '1100148', 'RO'),
       ...
       ('Epitaciolândia', '1200252', 'AC'),
       ('Feijó', '1200302', 'AC'),
       ('Jordão', '1200328', 'AC'),
       ('Mâncio Lima', '1200336', 'AC'),
       ('Manoel Urbano', '1200344', 'AC'),
       ('Marechal Thaumaturgo', '1200351', 'AC'),
       ('Plácido de Castro', '1200385', 'AC'),
       ...
       ('Bonfim', '1400159', 'RR'),
       ('Cantá', '1400175', 'RR'),
       ('Caracaraí', '1400209', 'RR'),
       ('Caroebe', '1400233', 'RR'),
       ('Iracema', '1400282', 'RR'),
       ('Mucajaí', '1400308', 'RR'),
       ('Normandia', '1400407', 'RR'),
       ('Pacaraima', '1400456', 'RR'),
       ('Rorainópolis', '1400472', 'RR'),
       ('São João da Baliza', '1400506', 'RR'),
       ('São Luiz', '1400605', 'RR'),
       ('Uiramutã', '1400704', 'RR'),
       ...
       ('Anapu', '1500859', 'PA'),
       ('Augusto Corrêa', '1500909', 'PA'),
       ('Aurora do Pará', '1500958', 'PA'),
       ('Aveiro', '1501006', 'PA'),
       ('Bagre', '1501105', 'PA'),
       ('Baião', '1501204', 'PA'),
       ('Bannach', '1501253', 'PA'),
       ...
       ('São Miguel do Guamá', '1507607', 'PA'),
       ('São Sebastião da Boa Vista', '1507706', 'PA'),
       ('Sapucaia', '1507755', 'PA'),
       ('Senador José Porfírio', '1507805', 'PA'),
       ('Soure', '1507904', 'PA'),
       ('Tailândia', '1507953', 'PA'),
       ...
       ('Tucumã', '1508084', 'PA'),
       ('Tucuruí', '1508100', 'PA'),
       ('Ulianópolis', '1508126', 'PA'),
       ('Uruará', '1508159', 'PA'),
       ('Vigia', '1508209', 'PA'),
       ('Viseu', '1508308', 'PA'),
       ('Vitória do Xingu', '1508357', 'PA'),
       ('Xinguara', '1508407', 'PA'),
       ('Amapá', '1600105', 'AP'),
       ('Calçoene', '1600204', 'AP'),
       ('Cutias', '1600212', 'AP'),
       ...
       ('Dois Irmãos do Tocantins', '1707207', 'TO'),
       ('Dueré', '1707306', 'TO'),
       ...
       ('Itaporã do Tocantins', '1711100', 'TO'),
       ('Jaú do Tocantins', '1711506', 'TO'),
       ('Juarina', '1711803', 'TO'),
       ('Lagoa da Confusão', '1711902', 'TO'),
       ...
       ('São Bento do Tocantins', '1720101', 'TO'),
       ('São Félix do Tocantins', '1720150', 'TO'),
       ('São Miguel do Tocantins', '1720200', 'TO'),
       ('São Salvador do Tocantins', '1720259', 'TO'),
       ('São Sebastião do Tocantins', '1720309', 'TO'),
       ('São Valério', '1720499', 'TO'),
       ...
       ('Xambioá', '1722107', 'TO'),
       ('Açailândia', '2100055', 'MA'),
       ('Afonso Cunha', '2100105', 'MA'),
       ('Água Doce do Maranhão', '2100154', 'MA'),
       ('Alcântara', '2100204', 'MA'),
       ('Aldeias Altas', '2100303', 'MA'),
       ('Altamira do Maranhão', '2100402', 'MA'),
       ('Alto Alegre do Maranhão', '2100436', 'MA'),
       ('Alto Alegre do Pindaré', '2100477', 'MA'),
       ('Alto Parnaíba', '2100501', 'MA'),
       ('Amapá do Maranhão', '2100550', 'MA'),
       ('Amarante do Maranhão', '2100600', 'MA'),
       ('Anajatuba', '2100709', 'MA'),
       ('Anapurus', '2100808', 'MA'),
       ('Apicum-Açu', '2100832', 'MA'),
       ('Araguanã', '2100873', 'MA'),
       ('Araioses', '2100907', 'MA'),
       ('Arame', '2100956', 'MA'),
       ('Arari', '2101004', 'MA'),
       ...
       ('Balsas', '2101400', 'MA'),
       ('Barão de Grajaú', '2101509', 'MA'),
       ('Barra do Corda', '2101608', 'MA'),
       ('Barreirinhas', '2101707', 'MA'),
       ('Bela Vista do Maranhão', '2101772', 'MA'),
       ('Belágua', '2101731', 'MA'),
       ...
       ('Cajapió', '2102408', 'MA'),
       ('Cajari', '2102507', 'MA'),
       ('Campestre do Maranhão', '2102556', 'MA'),
       ('Cândido Mendes', '2102606', 'MA'),
       ...
       ('Caxias', '2103000', 'MA'),
       ('Cedral', '2103109', 'MA'),
       ('Central do Maranhão', '2103125', 'MA'),
       ('Centro do Guilherme', '2103158', 'MA'),
       ('Centro Novo do Maranhão', '2103174', 'MA'),
       ('Chapadinha', '2103208', 'MA'),
       ('Cidelândia', '2103257', 'MA'),
       ('Codó', '2103307', 'MA'),
       ('Coelho Neto', '2103406', 'MA'),
       ('Colinas', '2103505', 'MA'),
       ('Conceição do Lago-Açu', '2103554', 'MA'),
       ('Coroatá', '2103604', 'MA'),
       ('Cururupu', '2103703', 'MA'),
       ('Davinópolis', '2103752', 'MA'),
       ('Dom Pedro', '2103802', 'MA'),
       ('Duque Bacelar', '2103901', 'MA'),
       ('Esperantinópolis', '2104008', 'MA'),
       ('Estreito', '2104057', 'MA'),
       ('Feira Nova do Maranhão', '2104073', 'MA'),
       ('Fernando Falcão', '2104081', 'MA'),
       ('Formosa da Serra Negra', '2104099', 'MA'),
       ('Fortaleza dos Nogueiras', '2104107', 'MA'),
       ('Fortuna', '2104206', 'MA'),
       ('Godofredo Viana', '2104305', 'MA'),
       ('Gonçalves Dias', '2104404', 'MA'),
       ('Governador Archer', '2104503', 'MA'),
       ('Governador Edison Lobão', '2104552', 'MA'),
       ('Governador Eugênio Barros', '2104602', 'MA'),
       ('Governador Luiz Rocha', '2104628', 'MA'),
       ('Governador Newton Bello', '2104651', 'MA'),
       ('Governador Nunes Freire', '2104677', 'MA'),
       ('Graça Aranha', '2104701', 'MA'),
       ('Grajaú', '2104800', 'MA'),
       ('Guimarães', '2104909', 'MA'),
       ('Humberto de Campos', '2105005', 'MA'),
       ('Icatu', '2105104', 'MA'),
       ('Igarapé do Meio', '2105153', 'MA'),
       ('Igarapé Grande', '2105203', 'MA'),
       ('Imperatriz', '2105302', 'MA'),
       ('Itaipava do Grajaú', '2105351', 'MA'),
       ('Itapecuru Mirim', '2105401', 'MA'),
       ('Itinga do Maranhão', '2105427', 'MA'),
       ('Jatobá', '2105450', 'MA'),
       ('Jenipapo dos Vieiras', '2105476', 'MA'),
       ('João Lisboa', '2105500', 'MA'),
       ('Joselândia', '2105609', 'MA'),
       ('Junco do Maranhão', '2105658', 'MA'),
       ...
       ('Lagoa Grande do Maranhão', '2105963', 'MA'),
       ('Lajeado Novo', '2105989', 'MA'),
       ('Lima Campos', '2106003', 'MA'),
       ('Loreto', '2106102', 'MA'),
       ('Luís Domingues', '2106201', 'MA'),
       ('Magalhães de Almeida', '2106300', 'MA'),
       ('Maracaçumé', '2106326', 'MA'),
       ('Marajá do Sena', '2106359', 'MA'),
       ('Maranhãozinho', '2106375', 'MA'),
       ('Mata Roma', '2106409', 'MA'),
       ('Matinha', '2106508', 'MA'),
       ('Matões', '2106607', 'MA'),
       ('Matões do Norte', '2106631', 'MA'),
       ('Milagres do Maranhão', '2106672', 'MA'),
       ('Mirador', '2106706', 'MA'),
       ...
       ('Nova Olinda do Maranhão', '2107357', 'MA'),
       ('Olho d''Água das Cunhãs', '2107407', 'MA'),
       ('Olinda Nova do Maranhão', '2107456', 'MA'),
       ('Paço do Lumiar', '2107506', 'MA'),
       ('Palmeirândia', '2107605', 'MA'),
       ...
       ('Pedro do Rosário', '2108256', 'MA'),
       ('Penalva', '2108306', 'MA'),
       ('Peri Mirim', '2108405', 'MA'),
       ('Peritoró', '2108454', 'MA'),
       ('Pindaré-Mirim', '2108504', 'MA'),
       ('Pinheiro', '2108603', 'MA'),
       ('Pio XII', '2108702', 'MA'),
       ('Pirapemas', '2108801', 'MA'),
       ('Poção de Pedras', '2108900', 'MA'),
       ('Porto Franco', '2109007', 'MA'),
       ('Porto Rico do Maranhão', '2109056', 'MA'),
       ('Presidente Dutra', '2109106', 'MA'),
       ('Presidente Juscelino', '2109205', 'MA'),
       ('Presidente Médici', '2109239', 'MA'),
       ...
       ('Rosário', '2109601', 'MA'),
       ('Sambaíba', '2109700', 'MA'),
       ('Santa Filomena do Maranhão', '2109759', 'MA'),
       ('Santa Helena', '2109809', 'MA'),
       ('Santa Inês', '2109908', 'MA'),
       ('Santa Luzia', '2110005', 'MA'),
       ('Santa Luzia do Paruá', '2110039', 'MA'),
       ('Santa Quitéria do Maranhão', '2110104', 'MA'),
       ('Santa Rita', '2110203', 'MA'),
       ('Santana do Maranhão', '2110237', 'MA'),
       ('Santo Amaro do Maranhão', '2110278', 'MA'),
       ('Santo Antônio dos Lopes', '2110302', 'MA'),
       ('São Benedito do Rio Preto', '2110401', 'MA'),
       ('São Bento', '2110500', 'MA'),
       ('São Bernardo', '2110609', 'MA'),
       ('São Domingos do Azeitão', '2110658', 'MA'),
       ('São Domingos do Maranhão', '2110708', 'MA'),
       ('São Félix de Balsas', '2110807', 'MA'),
       ('São Francisco do Brejão', '2110856', 'MA'),
       ('São Francisco do Maranhão', '2110906', 'MA'),
       ('São João Batista', '2111003', 'MA'),
       ('São João do Carú', '2111029', 'MA'),
       ('São João do Paraíso', '2111052', 'MA'),
       ('São João do Soter', '2111078', 'MA'),
       ('São João dos Patos', '2111102', 'MA'),
       ('São José de Ribamar', '2111201', 'MA'),
       ('São José dos Basílios', '2111250', 'MA'),
       ('São Luís', '2111300', 'MA'),
       ('São Luís Gonzaga do Maranhão', '2111409', 'MA'),
       ('São Mateus do Maranhão', '2111508', 'MA'),
       ('São Pedro da Água Branca', '2111532', 'MA'),
       ('São Pedro dos Crentes', '2111573', 'MA'),
       ('São Raimundo das Mangabeiras', '2111607', 'MA'),
       ('São Raimundo do Doca Bezerra', '2111631', 'MA'),
       ('São Roberto', '2111672', 'MA'),
       ('São Vicente Ferrer', '2111706', 'MA'),
       ('Satubinha', '2111722', 'MA'),
       ('Senador Alexandre Costa', '2111748', 'MA'),
       ('Senador La Rocque', '2111763', 'MA'),
       ('Serrano do Maranhão', '2111789', 'MA'),
       ('Sítio Novo', '2111805', 'MA'),
       ('Sucupira do Norte', '2111904', 'MA'),
       ('Sucupira do Riachão', '2111953', 'MA'),
       ('Tasso Fragoso', '2112001', 'MA'),
       ('Timbiras', '2112100', 'MA'),
       ('Timon', '2112209', 'MA'),
       ('Trizidela do Vale', '2112233', 'MA'),
       ('Tufilândia', '2112274', 'MA'),
       ('Tuntum', '2112308', 'MA'),
       ('Turiaçu', '2112407', 'MA'),
       ('Turilândia', '2112456', 'MA'),
       ('Tutóia', '2112506', 'MA'),
       ('Urbano Santos', '2112605', 'MA'),
       ('Vargem Grande', '2112704', 'MA'),
       ('Viana', '2112803', 'MA'),
       ('Vila Nova dos Martírios', '2112852', 'MA'),
       ('Vitória do Mearim', '2112902', 'MA'),
       ...
       ('Madalena', '2307635', 'CE'),
       ('Maracanaú', '2307650', 'CE'),
       ('Maranguape', '2307700', 'CE'),
       ('Marco', '2307809', 'CE'),
       ('Martinópole', '2307908', 'CE'),
       ('Massapê', '2308005', 'CE'),
       ('Mauriti', '2308104', 'CE'),
       ('Meruoca', '2308203', 'CE'),
       ('Milagres', '2308302', 'CE'),
       ...
       ('Saboeiro', '2311900', 'CE'),
       ('Salitre', '2311959', 'CE'),
       ('Santa Quitéria', '2312205', 'CE'),
       ('Santana do Acaraú', '2312007', 'CE'),
       ('Santana do Cariri', '2312106', 'CE'),
       ('São Benedito', '2312304', 'CE'),
       ('São Gonçalo do Amarante', '2312403', 'CE'),
       ('São João do Jaguaribe', '2312502', 'CE'),
       ('São Luís do Curu', '2312601', 'CE'),
       ('Senador Pompeu', '2312700', 'CE'),
       ('Senador Sá', '2312809', 'CE'),
       ('Sobral', '2312908', 'CE'),
       ('Solonópole', '2313005', 'CE'),
       ('Tabuleiro do Norte', '2313104', 'CE'),
       ('Tamboril', '2313203', 'CE'),
       ('Tarrafas', '2313252', 'CE'),
       ('Tauá', '2313302', 'CE'),
       ('Tejuçuoca', '2313351', 'CE'),
       ('Tianguá', '2313401', 'CE'),
       ('Trairi', '2313500', 'CE'),
       ('Tururu', '2313559', 'CE'),
       ('Ubajara', '2313609', 'CE'),
       ...
       ('Brejinho', '2401800', 'RN'),
       ('Caiçara do Norte', '2401859', 'RN'),
       ('Caiçara do Rio do Vento', '2401909', 'RN'),
       ('Caicó', '2402006', 'RN'),
       ('Campo Grande', '2401305', 'RN'),
       ('Campo Redondo', '2402105', 'RN'),
       ('Canguaretama', '2402204', 'RN'),
       ('Caraúbas', '2402303', 'RN'),
       ('Carnaúba dos Dantas', '2402402', 'RN'),
       ('Carnaubais', '2402501', 'RN'),
       ('Ceará-Mirim', '2402600', 'RN'),
       ('Cerro Corá', '2402709', 'RN'),
       ('Coronel Ezequiel', '2402808', 'RN'),
       ('Coronel João Pessoa', '2402907', 'RN'),
       ('Cruzeta', '2403004', 'RN'),
       ('Currais Novos', '2403103', 'RN'),
       ('Doutor Severiano', '2403202', 'RN'),
       ('Encanto', '2403301', 'RN'),
       ('Equador', '2403400', 'RN'),
       ('Espírito Santo', '2403509', 'RN'),
       ('Extremoz', '2403608', 'RN'),
       ...
       ('Jandaíra', '2405108', 'RN'),
       ('Janduís', '2405207', 'RN'),
       ('Januário Cicco', '2405306', 'RN'),
       ('Japi', '2405405', 'RN'),
       ('Jardim de Angicos', '2405504', 'RN'),
       ('Jardim de Piranhas', '2405603', 'RN'),
       ('Jardim do Seridó', '2405702', 'RN'),
       ('João Câmara', '2405801', 'RN'),
       ('João Dias', '2405900', 'RN'),
       ('José da Penha', '2406007', 'RN'),
       ('Jucurutu', '2406106', 'RN'),
       ('Jundiá', '2406155', 'RN'),
       ('Lagoa d''Anta', '2406205', 'RN'),
       ...
       ('Mossoró', '2408003', 'RN'),
       ('Natal', '2408102', 'RN'),
       ('Nísia Floresta', '2408201', 'RN'),
       ('Nova Cruz', '2408300', 'RN'),
       ('Olho d''Água do Borges', '2408409', 'RN'),
       ...
       ('Pendências', '2409902', 'RN'),
       ('Pilões', '2410009', 'RN'),
       ('Poço Branco', '2410108', 'RN'),
       ...
       ('Santana do Seridó', '2411429', 'RN'),
       ('Santo Antônio', '2411502', 'RN'),
       ('São Bento do Norte', '2411601', 'RN'),
       ('São Bento do Trairí', '2411700', 'RN'),
       ('São Fernando', '2411809', 'RN'),
       ('São Francisco do Oeste', '2411908', 'RN'),
       ('São Gonçalo do Amarante', '2412005', 'RN'),
       ('São João do Sabugi', '2412104', 'RN'),
       ('São José de Mipibu', '2412203', 'RN'),
       ('São José do Campestre', '2412302', 'RN'),
       ('São José do Seridó', '2412401', 'RN'),
       ('São Miguel', '2412500', 'RN'),
       ('São Miguel do Gostoso', '2412559', 'RN'),
       ('São Paulo do Potengi', '2412609', 'RN'),
       ('São Pedro', '2412708', 'RN'),
       ('São Rafael', '2412807', 'RN'),
       ('São Tomé', '2412906', 'RN'),
       ('São Vicente', '2413003', 'RN'),
       ('Senador Elói de Souza', '2413102', 'RN'),
       ('Senador Georgino Avelino', '2413201', 'RN'),
       ('Serra Caiada', '2410306', 'RN'),
       ('Serra de São Bento', '2413300', 'RN'),
       ('Serra do Mel', '2413359', 'RN'),
       ('Serra Negra do Norte', '2413409', 'RN'),
       ('Serrinha', '2413508', 'RN'),
       ('Serrinha dos Pintos', '2413557', 'RN'),
       ('Severiano Melo', '2413607', 'RN'),
       ('Sítio Novo', '2413706', 'RN'),
       ...
       ('Timbaúba dos Batistas', '2414308', 'RN'),
       ('Touros', '2414407', 'RN'),
       ...
       ('Água Preta', '2600401', 'PE'),
       ('Águas Belas', '2600500', 'PE'),
       ('Alagoinha', '2600609', 'PE'),
       ('Aliança', '2600708', 'PE'),
       ('Altinho', '2600807', 'PE'),
       ('Amaraji', '2600906', 'PE'),
       ('Angelim', '2601003', 'PE'),
       ('Araçoiaba', '2601052', 'PE'),
       ('Araripina', '2601102', 'PE'),
       ('Arcoverde', '2601201', 'PE'),
       ('Barra de Guabiraba', '2601300', 'PE'),
       ('Barreiros', '2601409', 'PE'),
       ('Belém de Maria', '2601508', 'PE'),
       ('Belém do São Francisco', '2601607', 'PE'),
       ...
       ('Camocim de São Félix', '2603504', 'PE'),
       ...
       ('Catende', '2604205', 'PE'),
       ('Cedro', '2604304', 'PE'),
       ('Chã de Alegria', '2604403', 'PE'),
       ('Chã Grande', '2604502', 'PE'),
       ('Condado', '2604601', 'PE'),
       ...
       ('Moreilândia', '2614303', 'PE'),
       ('Moreno', '2609402', 'PE'),
       ('Nazaré da Mata', '2609501', 'PE'),
       ('Olinda', '2609600', 'PE'),
       ('Orobó', '2609709', 'PE'),
       ('Orocó', '2609808', 'PE'),
       ('Ouricuri', '2609907', 'PE'),
       ...
       ('Santa Maria do Cambucá', '2612703', 'PE'),
       ('Santa Terezinha', '2612802', 'PE'),
       ('São Benedito do Sul', '2612901', 'PE'),
       ('São Bento do Una', '2613008', 'PE'),
       ('São Caitano', '2613107', 'PE'),
       ('São João', '2613206', 'PE'),
       ('São Joaquim do Monte', '2613305', 'PE'),
       ('São José da Coroa Grande', '2613404', 'PE'),
       ('São José do Belmonte', '2613503', 'PE'),
       ('São José do Egito', '2613602', 'PE'),
       ('São Lourenço da Mata', '2613701', 'PE'),
       ('São Vicente Férrer', '2613800', 'PE'),
       ('Serra Talhada', '2613909', 'PE'),
       ('Serrita', '2614006', 'PE'),
       ('Sertânia', '2614105', 'PE'),
       ('Sirinhaém', '2614204', 'PE'),
       ('Solidão', '2614402', 'PE'),
       ('Surubim', '2614501', 'PE'),
       ('Tabira', '2614600', 'PE'),
       ('Tacaimbó', '2614709', 'PE'),
       ('Tacaratu', '2614808', 'PE'),
       ('Tamandaré', '2614857', 'PE'),
       ('Taquaritinga do Norte', '2615003', 'PE'),
       ('Terezinha', '2615102', 'PE'),
       ('Terra Nova', '2615201', 'PE'),
       ('Timbaúba', '2615300', 'PE'),
       ('Toritama', '2615409', 'PE'),
       ('Tracunhaém', '2615508', 'PE'),
       ('Trindade', '2615607', 'PE'),
       ('Triunfo', '2615706', 'PE'),
       ...
       ('Vertente do Lério', '2616183', 'PE'),
       ('Vertentes', '2616209', 'PE'),
       ('Vicência', '2616308', 'PE'),
       ('Vitória de Santo Antão', '2616407', 'PE'),
       ('Xexéu', '2616506', 'PE'),
       ...
       ('Adustina', '2900355', 'BA'),
       ('Água Fria', '2900405', 'BA'),
       ('Aiquara', '2900603', 'BA'),
       ('Alagoinhas', '2900702', 'BA'),
       ('Alcobaça', '2900801', 'BA'),
       ('Almadina', '2900900', 'BA'),
       ('Amargosa', '2901007', 'BA'),
       ('Amélia Rodrigues', '2901106', 'BA'),
       ('América Dourada', '2901155', 'BA'),
       ('Anagé', '2901205', 'BA'),
       ('Andaraí', '2901304', 'BA'),
       ...
       ('Anguera', '2901502', 'BA'),
       ('Antas', '2901601', 'BA'),
       ('Antônio Cardoso', '2901700', 'BA'),
       ('Antônio Gonçalves', '2901809', 'BA'),
       ('Aporá', '2901908', 'BA'),
       ('Apuarema', '2901957', 'BA'),
       ('Araçás', '2902054', 'BA'),
       ('Aracatu', '2902005', 'BA'),
       ...
       ('Botuporã', '2904209', 'BA'),
       ('Brejões', '2904308', 'BA'),
       ('Brejolândia', '2904407', 'BA'),
       ('Brotas de Macaúbas', '2904506', 'BA'),
       ('Brumado', '2904605', 'BA'),
       ('Buerarema', '2904704', 'BA'),
       ('Buritirama', '2904753', 'BA'),
       ('Caatiba', '2904803', 'BA'),
       ('Cabaceiras do Paraguaçu', '2904852', 'BA'),
       ...
       ('Cairu', '2905404', 'BA'),
       ('Caldeirão Grande', '2905503', 'BA'),
       ('Camacan', '2905602', 'BA'),
       ('Camaçari', '2905701', 'BA'),
       ('Camamu', '2905800', 'BA'),
       ('Campo Alegre de Lourdes', '2905909', 'BA'),
       ('Campo Formoso', '2906006', 'BA'),
       ('Canápolis', '2906105', 'BA'),
       ('Canarana', '2906204', 'BA'),
       ('Canavieiras', '2906303', 'BA'),
       ('Candeal', '2906402', 'BA'),
       ('Candeias', '2906501', 'BA'),
       ('Candiba', '2906600', 'BA'),
       ('Cândido Sales', '2906709', 'BA'),
       ('Cansanção', '2906808', 'BA'),
       ('Canudos', '2906824', 'BA'),
       ...
       ('Catolândia', '2907400', 'BA'),
       ('Catu', '2907509', 'BA'),
       ('Caturama', '2907558', 'BA'),
       ('Central', '2907608', 'BA'),
       ('Chorrochó', '2907707', 'BA'),
       ('Cícero Dantas', '2907806', 'BA'),
       ('Cipó', '2907905', 'BA'),
       ('Coaraci', '2908002', 'BA'),
       ('Cocos', '2908101', 'BA'),
       ('Conceição da Feira', '2908200', 'BA'),
       ('Conceição do Almeida', '2908309', 'BA'),
       ('Conceição do Coité', '2908408', 'BA'),
       ('Conceição do Jacuípe', '2908507', 'BA'),
       ('Conde', '2908606', 'BA'),
       ('Condeúba', '2908705', 'BA'),
       ('Contendas do Sincorá', '2908804', 'BA'),
       ('Coração de Maria', '2908903', 'BA'),
       ('Cordeiros', '2909000', 'BA'),
       ('Coribe', '2909109', 'BA'),
       ('Coronel João Sá', '2909208', 'BA'),
       ('Correntina', '2909307', 'BA'),
       ('Cotegipe', '2909406', 'BA'),
       ('Cravolândia', '2909505', 'BA'),
       ('Crisópolis', '2909604', 'BA'),
       ('Cristópolis', '2909703', 'BA'),
       ('Cruz das Almas', '2909802', 'BA'),
       ('Curaçá', '2909901', 'BA'),
       ('Dário Meira', '2910008', 'BA'),
       ('Dias d''Ávila', '2910057', 'BA'),
       ('Dom Basílio', '2910107', 'BA'),
       ('Dom Macedo Costa', '2910206', 'BA'),
       ('Elísio Medrado', '2910305', 'BA'),
       ('Encruzilhada', '2910404', 'BA'),
       ('Entre Rios', '2910503', 'BA'),
       ('Érico Cardoso', '2900504', 'BA'),
       ('Esplanada', '2910602', 'BA'),
       ('Euclides da Cunha', '2910701', 'BA'),
       ('Eunápolis', '2910727', 'BA'),
       ('Fátima', '2910750', 'BA'),
       ('Feira da Mata', '2910776', 'BA'),
       ('Feira de Santana', '2910800', 'BA'),
       ('Filadélfia', '2910859', 'BA'),
       ...
       ('Heliópolis', '2911857', 'BA'),
       ('Iaçu', '2911907', 'BA'),
       ('Ibiassucê', '2912004', 'BA'),
       ('Ibicaraí', '2912103', 'BA'),
       ('Ibicoara', '2912202', 'BA'),
       ('Ibicuí', '2912301', 'BA'),
       ('Ibipeba', '2912400', 'BA'),
       ...
       ('Itaguaçu da Bahia', '2915353', 'BA'),
       ('Itaju do Colônia', '2915403', 'BA'),
       ('Itajuípe', '2915502', 'BA'),
       ...
       ('Jiquiriçá', '2918209', 'BA'),
       ('Jitaúna', '2918308', 'BA'),
       ('João Dourado', '2918357', 'BA'),
       ('Juazeiro', '2918407', 'BA'),
       ('Jucuruçu', '2918456', 'BA'),
       ('Jussara', '2918506', 'BA'),
       ('Jussari', '2918555', 'BA'),
       ...
       ('Lençóis', '2919306', 'BA'),
       ('Licínio de Almeida', '2919405', 'BA'),
       ('Livramento de Nossa Senhora', '2919504', 'BA'),
       ('Luís Eduardo Magalhães', '2919553', 'BA'),
       ('Macajuba', '2919603', 'BA'),
       ('Macarani', '2919702', 'BA'),
       ('Macaúbas', '2919801', 'BA'),
       ('Macururé', '2919900', 'BA'),
       ...
       ('Maraú', '2920700', 'BA'),
       ('Marcionílio Souza', '2920809', 'BA'),
       ('Mascote', '2920908', 'BA'),
       ('Mata de São João', '2921005', 'BA'),
       ('Matina', '2921054', 'BA'),
       ...
       ('Muquém do São Francisco', '2922250', 'BA'),
       ('Muritiba', '2922300', 'BA'),
       ('Mutuípe', '2922409', 'BA'),
       ('Nazaré', '2922508', 'BA'),
       ('Nilo Peçanha', '2922607', 'BA'),
       ('Nordestina', '2922656', 'BA'),
       ('Nova Canaã', '2922706', 'BA'),
       ('Nova Fátima', '2922730', 'BA'),
       ('Nova Ibiá', '2922755', 'BA'),
       ('Nova Itarana', '2922805', 'BA'),
       ('Nova Redenção', '2922854', 'BA'),
       ('Nova Soure', '2922904', 'BA'),
       ('Nova Viçosa', '2923001', 'BA'),
       ('Novo Horizonte', '2923035', 'BA'),
       ('Novo Triunfo', '2923050', 'BA'),
       ('Olindina', '2923100', 'BA'),
       ('Oliveira dos Brejinhos', '2923209', 'BA'),
       ('Ouriçangas', '2923308', 'BA'),
       ('Ourolândia', '2923357', 'BA'),
       ...
       ('Pé de Serra', '2924058', 'BA'),
       ('Pedrão', '2924108', 'BA'),
       ('Pedro Alexandre', '2924207', 'BA'),
       ('Piatã', '2924306', 'BA'),
       ('Pilão Arcado', '2924405', 'BA'),
       ('Pindaí', '2924504', 'BA'),
       ('Pindobaçu', '2924603', 'BA'),
       ('Pintadas', '2924652', 'BA'),
       ('Piraí do Norte', '2924678', 'BA'),
       ('Piripá', '2924702', 'BA'),
       ('Piritiba', '2924801', 'BA'),
       ...
       ('Potiraguá', '2925402', 'BA'),
       ('Prado', '2925501', 'BA'),
       ('Presidente Dutra', '2925600', 'BA'),
       ('Presidente Jânio Quadros', '2925709', 'BA'),
       ...
       ('Remanso', '2926004', 'BA'),
       ('Retirolândia', '2926103', 'BA'),
       ('Riachão das Neves', '2926202', 'BA'),
       ('Riachão do Jacuípe', '2926301', 'BA'),
       ('Riacho de Santana', '2926400', 'BA'),
       ('Ribeira do Amparo', '2926509', 'BA'),
       ('Ribeira do Pombal', '2926608', 'BA'),
       ('Ribeirão do Largo', '2926657', 'BA'),
       ('Rio de Contas', '2926707', 'BA'),
       ('Rio do Antônio', '2926806', 'BA'),
       ...
       ('Salvador', '2927408', 'BA'),
       ('Santa Bárbara', '2927507', 'BA'),
       ('Santa Brígida', '2927606', 'BA'),
       ('Santa Cruz Cabrália', '2927705', 'BA'),
       ('Santa Cruz da Vitória', '2927804', 'BA'),
       ('Santa Inês', '2927903', 'BA'),
       ('Santa Luzia', '2928059', 'BA'),
       ('Santa Maria da Vitória', '2928109', 'BA'),
       ('Santa Rita de Cássia', '2928406', 'BA'),
       ('Santa Terezinha', '2928505', 'BA'),
       ('Santaluz', '2928000', 'BA'),
       ('Santana', '2928208', 'BA'),
       ('Santanópolis', '2928307', 'BA'),
       ('Santo Amaro', '2928604', 'BA'),
       ('Santo Antônio de Jesus', '2928703', 'BA'),
       ('Santo Estêvão', '2928802', 'BA'),
       ('São Desidério', '2928901', 'BA'),
       ('São Domingos', '2928950', 'BA'),
       ('São Felipe', '2929107', 'BA'),
       ('São Félix', '2929008', 'BA'),
       ('São Félix do Coribe', '2929057', 'BA'),
       ('São Francisco do Conde', '2929206', 'BA'),
       ('São Gabriel', '2929255', 'BA'),
       ('São Gonçalo dos Campos', '2929305', 'BA'),
       ('São José da Vitória', '2929354', 'BA'),
       ('São José do Jacuípe', '2929370', 'BA'),
       ('São Miguel das Matas', '2929404', 'BA'),
       ('São Sebastião do Passé', '2929503', 'BA'),
       ('Sapeaçu', '2929602', 'BA'),
       ('Sátiro Dias', '2929701', 'BA'),
       ('Saubara', '2929750', 'BA'),
       ('Saúde', '2929800', 'BA'),
       ('Seabra', '2929909', 'BA'),
       ('Sebastião Laranjeiras', '2930006', 'BA'),
       ...
       ('Serrinha', '2930501', 'BA'),
       ('Serrolândia', '2930600', 'BA'),
       ('Simões Filho', '2930709', 'BA'),
       ('Sítio do Mato', '2930758', 'BA'),
       ('Sítio do Quinto', '2930766', 'BA'),
       ...
       ('Taperoá', '2931202', 'BA'),
       ('Tapiramutá', '2931301', 'BA'),
       ('Teixeira de Freitas', '2931350', 'BA'),
       ('Teodoro Sampaio', '2931400', 'BA'),
       ('Teofilândia', '2931509', 'BA'),
       ('Teolândia', '2931608', 'BA'),
       ...
       ('Valença', '2932903', 'BA'),
       ('Valente', '2933000', 'BA'),
       ('Várzea da Roça', '2933059', 'BA'),
       ('Várzea do Poço', '2933109', 'BA'),
       ('Várzea Nova', '2933158', 'BA'),
       ('Varzedo', '2933174', 'BA'),
       ...
       ('Wenceslau Guimarães', '2933505', 'BA'),
       ...
       ('Araruama', '3300209', 'RJ'),
       ('Areal', '3300225', 'RJ'),
       ('Armação dos Búzios', '3300233', 'RJ'),
       ('Arraial do Cabo', '3300258', 'RJ'),
       ('Barra do Piraí', '3300308', 'RJ'),
       ...
       ('Conceição de Macabu', '3301405', 'RJ'),
       ('Cordeiro', '3301504', 'RJ'),
       ...
       ('Santo Antônio de Pádua', '3304706', 'RJ'),
       ('São Fidélis', '3304805', 'RJ'),
       ('São Francisco de Itabapoana', '3304755', 'RJ'),
       ('São Gonçalo', '3304904', 'RJ'),
       ('São João da Barra', '3305000', 'RJ'),
       ('São João de Meriti', '3305109', 'RJ'),
       ('São José de Ubá', '3305133', 'RJ'),
       ('São José do Vale do Rio Preto', '3305158', 'RJ'),
       ('São Pedro da Aldeia', '3305208', 'RJ'),
       ('São Sebastião do Alto', '3305307', 'RJ'),
       ('Sapucaia', '3305406', 'RJ'),
       ('Saquarema', '3305505', 'RJ'),
       ('Seropédica', '3305554', 'RJ'),
       ('Silva Jardim', '3305604', 'RJ'),
       ('Sumidouro', '3305703', 'RJ'),
       ('Tanguá', '3305752', 'RJ'),
       ('Teresópolis', '3305802', 'RJ'),
       ('Trajano de Moraes', '3305901', 'RJ'),
       ('Três Rios', '3306008', 'RJ'),
       ('Valença', '3306107', 'RJ'),
       ...
       ('Bofete', '3506904', 'SP'),
       ('Boituva', '3507001', 'SP'),
       ('Bom Jesus dos Perdões', '3507100', 'SP'),
       ...
       ('São Luiz do Paraitinga', '3550001', 'SP'),
       ...
       ('Zacarias', '3557154', 'SP'),
       ('Abatiá', '4100103', 'PR'),
       ('Adrianópolis', '4100202', 'PR'),
       ('Agudos do Sul', '4100301', 'PR'),
       ('Almirante Tamandaré', '4100400', 'PR'),
       ('Altamira do Paraná', '4100459', 'PR'),
       ('Alto Paraíso', '4128625', 'PR'),
       ('Alto Paraná', '4100608', 'PR'),
       ...
       ('Ângulo', '4101150', 'PR'),
       ('Antonina', '4101200', 'PR'),
       ('Antônio Olinto', '4101309', 'PR'),
       ('Apucarana', '4101408', 'PR'),
       ('Arapongas', '4101507', 'PR'),
       ('Arapoti', '4101606', 'PR'),
       ('Arapuã', '4101655', 'PR'),
       ('Araruna', '4101705', 'PR'),
       ('Araucária', '4101804', 'PR'),
       ('Ariranha do Ivaí', '4101853', 'PR'),
       ('Assaí', '4101903', 'PR'),
       ...
       ('Barra do Jacaré', '4102703', 'PR'),
       ('Barracão', '4102604', 'PR'),
       ('Bela Vista da Caroba', '4102752', 'PR'),
       ('Bela Vista do Paraíso', '4102802', 'PR'),
       ('Bituruna', '4102901', 'PR'),
       ('Boa Esperança', '4103008', 'PR'),
       ('Boa Esperança do Iguaçu', '4103024', 'PR'),
       ('Boa Ventura de São Roque', '4103040', 'PR'),
       ('Boa Vista da Aparecida', '4103057', 'PR'),
       ('Bocaiúva do Sul', '4103107', 'PR'),
       ('Bom Jesus do Sul', '4103156', 'PR'),
       ('Bom Sucesso', '4103206', 'PR'),
       ('Bom Sucesso do Sul', '4103222', 'PR'),
       ('Borrazópolis', '4103305', 'PR'),
       ('Braganey', '4103354', 'PR'),
       ('Brasilândia do Sul', '4103370', 'PR'),
       ('Cafeara', '4103404', 'PR'),
       ('Cafelândia', '4103453', 'PR'),
       ('Cafezal do Sul', '4103479', 'PR'),
       ('Califórnia', '4103503', 'PR'),
       ('Cambará', '4103602', 'PR'),
       ('Cambé', '4103701', 'PR'),
       ('Cambira', '4103800', 'PR'),
       ('Campina da Lagoa', '4103909', 'PR'),
       ('Campina do Simão', '4103958', 'PR'),
       ...
       ('Campo Mourão', '4104303', 'PR'),
       ('Cândido de Abreu', '4104402', 'PR'),
       ('Candói', '4104428', 'PR'),
       ('Cantagalo', '4104451', 'PR'),
       ('Capanema', '4104501', 'PR'),
       ('Capitão Leônidas Marques', '4104600', 'PR'),
       ('Carambeí', '4104659', 'PR'),
       ('Carlópolis', '4104709', 'PR'),
       ('Cascavel', '4104808', 'PR'),
       ('Castro', '4104907', 'PR'),
       ('Catanduvas', '4105003', 'PR'),
       ('Centenário do Sul', '4105102', 'PR'),
       ('Cerro Azul', '4105201', 'PR'),
       ('Céu Azul', '4105300', 'PR'),
       ('Chopinzinho', '4105409', 'PR'),
       ('Cianorte', '4105508', 'PR'),
       ('Cidade Gaúcha', '4105607', 'PR'),
       ('Clevelândia', '4105706', 'PR'),
       ('Colombo', '4105805', 'PR'),
       ('Colorado', '4105904', 'PR'),
       ...
       ('Contenda', '4106209', 'PR'),
       ('Corbélia', '4106308', 'PR'),
       ('Cornélio Procópio', '4106407', 'PR'),
       ('Coronel Domingos Soares', '4106456', 'PR'),
       ('Coronel Vivida', '4106506', 'PR'),
       ('Corumbataí do Sul', '4106555', 'PR'),
       ('Cruz Machado', '4106803', 'PR'),
       ('Cruzeiro do Iguaçu', '4106571', 'PR'),
       ...
       ('Diamante D''Oeste', '4107157', 'PR'),
       ('Dois Vizinhos', '4107207', 'PR'),
       ('Douradina', '4107256', 'PR'),
       ('Doutor Camargo', '4107306', 'PR'),
       ('Doutor Ulysses', '4128633', 'PR'),
       ('Enéas Marques', '4107405', 'PR'),
       ('Engenheiro Beltrão', '4107504', 'PR'),
       ('Entre Rios do Oeste', '4107538', 'PR'),
       ('Esperança Nova', '4107520', 'PR'),
       ('Espigão Alto do Iguaçu', '4107546', 'PR'),
       ('Farol', '4107553', 'PR'),
       ('Faxinal', '4107603', 'PR'),
       ...
       ('Guaraci', '4109203', 'PR'),
       ('Guaraniaçu', '4109302', 'PR'),
       ('Guarapuava', '4109401', 'PR'),
       ('Guaraqueçaba', '4109500', 'PR'),
       ('Guaratuba', '4109609', 'PR'),
       ('Honório Serpa', '4109658', 'PR'),
       ('Ibaiti', '4109708', 'PR'),
       ('Ibema', '4109757', 'PR'),
       ('Ibiporã', '4109807', 'PR'),
       ('Icaraíma', '4109906', 'PR'),
       ...
       ('Imbaú', '4110078', 'PR'),
       ('Imbituva', '4110102', 'PR'),
       ('Inácio Martins', '4110201', 'PR'),
       ('Inajá', '4110300', 'PR'),
       ('Indianópolis', '4110409', 'PR'),
       ('Ipiranga', '4110508', 'PR'),
       ('Iporã', '4110607', 'PR'),
       ...
       ('Iretama', '4110805', 'PR'),
       ('Itaguajé', '4110904', 'PR'),
       ('Itaipulândia', '4110953', 'PR'),
       ('Itambaracá', '4111001', 'PR'),
       ('Itambé', '4111100', 'PR'),
       ('Itapejara d''Oeste', '4111209', 'PR'),
       ('Itaperuçu', '4111258', 'PR'),
       ('Itaúna do Sul', '4111308', 'PR'),
       ('Ivaí', '4111407', 'PR'),
       ('Ivaiporã', '4111506', 'PR'),
       ('Ivaté', '4111555', 'PR'),
       ('Ivatuba', '4111605', 'PR'),
       ...
       ('Jaguapitã', '4111902', 'PR'),
       ('Jaguariaíva', '4112009', 'PR'),
       ('Jandaia do Sul', '4112108', 'PR'),
       ('Janiópolis', '4112207', 'PR'),
       ('Japira', '4112306', 'PR'),
       ('Japurá', '4112405', 'PR'),
       ...
       ('Jesuítas', '4112751', 'PR'),
       ('Joaquim Távora', '4112801', 'PR'),
       ('Jundiaí do Sul', '4112900', 'PR'),
       ('Juranda', '4112959', 'PR'),
       ('Jussara', '4113007', 'PR'),
       ('Kaloré', '4113106', 'PR'),
       ('Lapa', '4113205', 'PR'),
       ...
       ('Lupionópolis', '4113809', 'PR'),
       ('Mallet', '4113908', 'PR'),
       ('Mamborê', '4114005', 'PR'),
       ('Mandaguaçu', '4114104', 'PR'),
       ('Mandaguari', '4114203', 'PR'),
       ('Mandirituba', '4114302', 'PR'),
       ('Manfrinópolis', '4114351', 'PR'),
       ('Mangueirinha', '4114401', 'PR'),
       ('Manoel Ribas', '4114500', 'PR'),
       ('Marechal Cândido Rondon', '4114609', 'PR'),
       ('Maria Helena', '4114708', 'PR'),
       ('Marialva', '4114807', 'PR'),
       ('Marilândia do Sul', '4114906', 'PR'),
       ('Marilena', '4115002', 'PR'),
       ('Mariluz', '4115101', 'PR'),
       ('Maringá', '4115200', 'PR'),
       ('Mariópolis', '4115309', 'PR'),
       ('Maripá', '4115358', 'PR'),
       ('Marmeleiro', '4115408', 'PR'),
       ('Marquinho', '4115457', 'PR'),
       ('Marumbi', '4115507', 'PR'),
       ('Matelândia', '4115606', 'PR'),
       ('Matinhos', '4115705', 'PR'),
       ('Mato Rico', '4115739', 'PR'),
       ('Mauá da Serra', '4115754', 'PR'),
       ...
       ('Nossa Senhora das Graças', '4116406', 'PR'),
       ('Nova Aliança do Ivaí', '4116505', 'PR'),
       ('Nova América da Colina', '4116604', 'PR'),
       ('Nova Aurora', '4116703', 'PR'),
       ('Nova Cantu', '4116802', 'PR'),
       ('Nova Esperança', '4116901', 'PR'),
       ('Nova Esperança do Sudoeste', '4116950', 'PR'),
       ('Nova Fátima', '4117008', 'PR'),
       ('Nova Laranjeiras', '4117057', 'PR'),
       ('Nova Londrina', '4117107', 'PR'),
       ('Nova Olímpia', '4117206', 'PR'),
       ('Nova Prata do Iguaçu', '4117255', 'PR'),
       ('Nova Santa Bárbara', '4117214', 'PR'),
       ...
       ('Palmital', '4117800', 'PR'),
       ('Palotina', '4117909', 'PR'),
       ('Paraíso do Norte', '4118006', 'PR'),
       ('Paranacity', '4118105', 'PR'),
       ('Paranaguá', '4118204', 'PR'),
       ('Paranapoema', '4118303', 'PR'),
       ('Paranavaí', '4118402', 'PR'),
       ...
       ('Perobal', '4118857', 'PR'),
       ('Pérola', '4118907', 'PR'),
       ('Pérola d''Oeste', '4119004', 'PR'),
       ('Piên', '4119103', 'PR'),
       ('Pinhais', '4119152', 'PR'),
       ('Pinhal de São Bento', '4119251', 'PR'),
       ('Pinhalão', '4119202', 'PR'),
       ('Pinhão', '4119301', 'PR'),
       ('Piraí do Sul', '4119400', 'PR'),
       ('Piraquara', '4119509', 'PR'),
       ('Pitanga', '4119608', 'PR'),
       ('Pitangueiras', '4119657', 'PR'),
       ('Planaltina do Paraná', '4119707', 'PR'),
       ('Planalto', '4119806', 'PR'),
       ('Ponta Grossa', '4119905', 'PR'),
       ('Pontal do Paraná', '4119954', 'PR'),
       ('Porecatu', '4120002', 'PR'),
       ('Porto Amazonas', '4120101', 'PR'),
       ('Porto Barreiro', '4120150', 'PR'),
       ('Porto Rico', '4120200', 'PR'),
       ('Porto Vitória', '4120309', 'PR'),
       ('Prado Ferreira', '4120333', 'PR'),
       ('Pranchita', '4120358', 'PR'),
       ('Presidente Castelo Branco', '4120408', 'PR'),
       ('Primeiro de Maio', '4120507', 'PR'),
       ('Prudentópolis', '4120606', 'PR'),
       ('Quarto Centenário', '4120655', 'PR'),
       ('Quatiguá', '4120705', 'PR'),
       ('Quatro Barras', '4120804', 'PR'),
       ('Quatro Pontes', '4120853', 'PR'),
       ('Quedas do Iguaçu', '4120903', 'PR'),
       ('Querência do Norte', '4121000', 'PR'),
       ('Quinta do Sol', '4121109', 'PR'),
       ('Quitandinha', '4121208', 'PR'),
       ('Ramilândia', '4121257', 'PR'),
       ('Rancho Alegre', '4121307', 'PR'),
       ('Rancho Alegre D''Oeste', '4121356', 'PR'),
       ('Realeza', '4121406', 'PR'),
       ('Rebouças', '4121505', 'PR'),
       ('Renascença', '4121604', 'PR'),
       ('Reserva', '4121703', 'PR'),
       ('Reserva do Iguaçu', '4121752', 'PR'),
       ('Ribeirão Claro', '4121802', 'PR'),
       ('Ribeirão do Pinhal', '4121901', 'PR'),
       ('Rio Azul', '4122008', 'PR'),
       ('Rio Bom', '4122107', 'PR'),
       ('Rio Bonito do Iguaçu', '4122156', 'PR'),
       ('Rio Branco do Ivaí', '4122172', 'PR'),
       ('Rio Branco do Sul', '4122206', 'PR'),
       ('Rio Negro', '4122305', 'PR'),
       ('Rolândia', '4122404', 'PR'),
       ('Roncador', '4122503', 'PR'),
       ('Rondon', '4122602', 'PR'),
       ('Rosário do Ivaí', '4122651', 'PR'),
       ('Sabáudia', '4122701', 'PR'),
       ('Salgado Filho', '4122800', 'PR'),
       ('Salto do Itararé', '4122909', 'PR'),
       ('Salto do Lontra', '4123006', 'PR'),
       ('Santa Amélia', '4123105', 'PR'),
       ('Santa Cecília do Pavão', '4123204', 'PR'),
       ('Santa Cruz de Monte Castelo', '4123303', 'PR'),
       ('Santa Fé', '4123402', 'PR'),
       ('Santa Helena', '4123501', 'PR'),
       ('Santa Inês', '4123600', 'PR'),
       ('Santa Isabel do Ivaí', '4123709', 'PR'),
       ('Santa Izabel do Oeste', '4123808', 'PR'),
       ('Santa Lúcia', '4123824', 'PR'),
       ('Santa Maria do Oeste', '4123857', 'PR'),
       ('Santa Mariana', '4123907', 'PR'),
       ('Santa Mônica', '4123956', 'PR'),
       ('Santa Tereza do Oeste', '4124020', 'PR'),
       ('Santa Terezinha de Itaipu', '4124053', 'PR'),
       ('Santana do Itararé', '4124004', 'PR'),
       ('Santo Antônio da Platina', '4124103', 'PR'),
       ('Santo Antônio do Caiuá', '4124202', 'PR'),
       ('Santo Antônio do Paraíso', '4124301', 'PR'),
       ('Santo Antônio do Sudoeste', '4124400', 'PR'),
       ('Santo Inácio', '4124509', 'PR'),
       ('São Carlos do Ivaí', '4124608', 'PR'),
       ('São Jerônimo da Serra', '4124707', 'PR'),
       ('São João', '4124806', 'PR'),
       ('São João do Caiuá', '4124905', 'PR'),
       ('São João do Ivaí', '4125001', 'PR'),
       ('São João do Triunfo', '4125100', 'PR'),
       ('São Jorge do Ivaí', '4125308', 'PR'),
       ('São Jorge do Patrocínio', '4125357', 'PR'),
       ('São Jorge d''Oeste', '4125209', 'PR'),
       ('São José da Boa Vista', '4125407', 'PR'),
       ('São José das Palmeiras', '4125456', 'PR'),
       ('São José dos Pinhais', '4125506', 'PR'),
       ('São Manoel do Paraná', '4125555', 'PR'),
       ('São Mateus do Sul', '4125605', 'PR'),
       ('São Miguel do Iguaçu', '4125704', 'PR'),
       ('São Pedro do Iguaçu', '4125753', 'PR'),
       ('São Pedro do Ivaí', '4125803', 'PR'),
       ('São Pedro do Paraná', '4125902', 'PR'),
       ('São Sebastião da Amoreira', '4126009', 'PR'),
       ('São Tomé', '4126108', 'PR'),
       ('Sapopema', '4126207', 'PR'),
       ('Sarandi', '4126256', 'PR'),
       ('Saudade do Iguaçu', '4126272', 'PR'),
       ('Sengés', '4126306', 'PR'),
       ('Serranópolis do Iguaçu', '4126355', 'PR'),
       ('Sertaneja', '4126405', 'PR'),
       ('Sertanópolis', '4126504', 'PR'),
       ...
       ('Toledo', '4127700', 'PR'),
       ('Tomazina', '4127809', 'PR'),
       ('Três Barras do Paraná', '4127858', 'PR'),
       ('Tunas do Paraná', '4127882', 'PR'),
       ('Tuneiras do Oeste', '4127908', 'PR'),
       ('Tupãssi', '4127957', 'PR'),
       ('Turvo', '4127965', 'PR'),
       ('Ubiratã', '4128005', 'PR'),
       ('Umuarama', '4128104', 'PR'),
       ('União da Vitória', '4128203', 'PR'),
       ('Uniflor', '4128302', 'PR'),
       ('Uraí', '4128401', 'PR'),
       ('Ventania', '4128534', 'PR'),
       ...
       ('Agrolândia', '4200200', 'SC'),
       ('Agronômica', '4200309', 'SC'),
       ('Água Doce', '4200408', 'SC'),
       ('Águas de Chapecó', '4200507', 'SC'),
       ('Águas Frias', '4200556', 'SC'),
       ('Águas Mornas', '4200606', 'SC'),
       ('Alfredo Wagner', '4200705', 'SC'),
       ('Alto Bela Vista', '4200754', 'SC'),
       ('Anchieta', '4200804', 'SC'),
       ('Angelina', '4200903', 'SC'),
       ('Anita Garibaldi', '4201000', 'SC'),
       ('Anitápolis', '4201109', 'SC'),
       ('Antônio Carlos', '4201208', 'SC'),
       ('Apiúna', '4201257', 'SC'),
       ('Arabutã', '4201273', 'SC'),
       ('Araquari', '4201307', 'SC'),
       ('Araranguá', '4201406', 'SC'),
       ('Armazém', '4201505', 'SC'),
       ...
       ('Atalanta', '4201802', 'SC'),
       ('Aurora', '4201901', 'SC'),
       ('Balneário Arroio do Silva', '4201950', 'SC'),
       ('Balneário Barra do Sul', '4202057', 'SC'),
       ('Balneário Camboriú', '4202008', 'SC'),
       ('Balneário Gaivota', '4202073', 'SC'),
       ('Balneário Piçarras', '4212809', 'SC'),
       ...
       ('Botuverá', '4202701', 'SC'),
       ('Braço do Norte', '4202800', 'SC'),
       ('Braço do Trombudo', '4202859', 'SC'),
       ('Brunópolis', '4202875', 'SC'),
       ('Brusque', '4202909', 'SC'),
       ('Caçador', '4203006', 'SC'),
       ('Caibi', '4203105', 'SC'),
       ('Calmon', '4203154', 'SC'),
       ...
       ('Chapadão do Lageado', '4204194', 'SC'),
       ('Chapecó', '4204202', 'SC'),
       ('Cocal do Sul', '4204251', 'SC'),
       ('Concórdia', '4204301', 'SC'),
       ...
       ('Corupá', '4204509', 'SC'),
       ('Criciúma', '4204608', 'SC'),
       ('Cunha Porã', '4204707', 'SC'),
       ('Cunhataí', '4204756', 'SC'),
       ('Curitibanos', '4204806', 'SC'),
       ('Descanso', '4204905', 'SC'),
       ('Dionísio Cerqueira', '4205001', 'SC'),
       ...
       ('Iomerê', '4207577', 'SC'),
       ('Ipira', '4207601', 'SC'),
       ('Iporã do Oeste', '4207650', 'SC'),
       ('Ipuaçu', '4207684', 'SC'),
       ('Ipumirim', '4207700', 'SC'),
       ('Iraceminha', '4207759', 'SC'),
       ('Irani', '4207809', 'SC'),
       ('Irati', '4207858', 'SC'),
       ('Irineópolis', '4207908', 'SC'),
       ('Itá', '4208005', 'SC'),
       ('Itaiópolis', '4208104', 'SC'),
       ('Itajaí', '4208203', 'SC'),
       ('Itapema', '4208302', 'SC'),
       ...
       ('Jaraguá do Sul', '4208906', 'SC'),
       ('Jardinópolis', '4208955', 'SC'),
       ('Joaçaba', '4209003', 'SC'),
       ('Joinville', '4209102', 'SC'),
       ('José Boiteux', '4209151', 'SC'),
       ('Jupiá', '4209177', 'SC'),
       ('Lacerdópolis', '4209201', 'SC'),
       ('Lages', '4209300', 'SC'),
       ('Laguna', '4209409', 'SC'),
       ('Lajeado Grande', '4209458', 'SC'),
       ('Laurentino', '4209508', 'SC'),
       ('Lauro Müller', '4209607', 'SC'),
       ('Lebon Régis', '4209706', 'SC'),
       ('Leoberto Leal', '4209805', 'SC'),
       ('Lindóia do Sul', '4209854', 'SC'),
       ('Lontras', '4209904', 'SC'),
       ...
       ('Riqueza', '4215075', 'SC'),
       ('Rodeio', '4215109', 'SC'),
       ('Romelândia', '4215208', 'SC'),
       ('Salete', '4215307', 'SC'),
       ('Saltinho', '4215356', 'SC'),
       ('Salto Veloso', '4215406', 'SC'),
       ('Sangão', '4215455', 'SC'),
       ('Santa Cecília', '4215505', 'SC'),
       ...
       ('São Bento do Sul', '4215802', 'SC'),
       ('São Bernardino', '4215752', 'SC'),
       ('São Bonifácio', '4215901', 'SC'),
       ('São Carlos', '4216008', 'SC'),
       ('São Cristóvão do Sul', '4216057', 'SC'),
       ('São Domingos', '4216107', 'SC'),
       ('São Francisco do Sul', '4216206', 'SC'),
       ('São João Batista', '4216305', 'SC'),
       ('São João do Itaperiú', '4216354', 'SC'),
       ('São João do Oeste', '4216255', 'SC'),
       ('São João do Sul', '4216404', 'SC'),
       ('São Joaquim', '4216503', 'SC'),
       ('São José', '4216602', 'SC'),
       ('São José do Cedro', '4216701', 'SC'),
       ('São José do Cerrito', '4216800', 'SC'),
       ('São Lourenço do Oeste', '4216909', 'SC'),
       ('São Ludgero', '4217006', 'SC'),
       ('São Martinho', '4217105', 'SC'),
       ('São Miguel da Boa Vista', '4217154', 'SC'),
       ('São Miguel do Oeste', '4217204', 'SC'),
       ('São Pedro de Alcântara', '4217253', 'SC'),
       ('Saudades', '4217303', 'SC'),
       ('Schroeder', '4217402', 'SC'),
       ('Seara', '4217501', 'SC'),
       ('Serra Alta', '4217550', 'SC'),
       ('Siderópolis', '4217600', 'SC'),
       ('Sombrio', '4217709', 'SC'),
       ...
       ('Tijucas', '4218004', 'SC'),
       ('Timbé do Sul', '4218103', 'SC'),
       ('Timbó', '4218202', 'SC'),
       ('Timbó Grande', '4218251', 'SC'),
       ('Três Barras', '4218301', 'SC'),
       ('Treviso', '4218350', 'SC'),
       ('Treze de Maio', '4218400', 'SC'),
       ('Treze Tílias', '4218509', 'SC'),
       ('Trombudo Central', '4218608', 'SC'),
       ('Tubarão', '4218707', 'SC'),
       ('Tunápolis', '4218756', 'SC'),
       ('Turvo', '4218806', 'SC'),
       ('União do Oeste', '4218855', 'SC'),
       ('Urubici', '4218905', 'SC'),
       ('Urupema', '4218954', 'SC'),
       ...
       ('Zortéa', '4219853', 'SC'),
       ('Aceguá', '4300034', 'RS'),
       ('Água Santa', '4300059', 'RS'),
       ('Agudo', '4300109', 'RS'),
       ('Ajuricaba', '4300208', 'RS'),
       ('Alecrim', '4300307', 'RS'),
       ('Alegrete', '4300406', 'RS'),
       ('Alegria', '4300455', 'RS'),
       ('Almirante Tamandaré do Sul', '4300471', 'RS'),
       ('Alpestre', '4300505', 'RS'),
       ...
       ('André da Rocha', '4300661', 'RS'),
       ('Anta Gorda', '4300703', 'RS'),
       ('Antônio Prado', '4300802', 'RS'),
       ('Arambaré', '4300851', 'RS'),
       ('Araricá', '4300877', 'RS'),
       ('Aratiba', '4300901', 'RS'),
       ...
       ('Áurea', '4301552', 'RS'),
       ('Bagé', '4301602', 'RS'),
       ('Balneário Pinhal', '4301636', 'RS'),
       ('Barão', '4301651', 'RS'),
       ('Barão de Cotegipe', '4301701', 'RS'),
       ('Barão do Triunfo', '4301750', 'RS'),
       ('Barra do Guarita', '4301859', 'RS'),
       ('Barra do Quaraí', '4301875', 'RS'),
       ...
       ('Camaquã', '4303509', 'RS'),
       ('Camargo', '4303558', 'RS'),
       ('Cambará do Sul', '4303608', 'RS'),
       ('Campestre da Serra', '4303673', 'RS'),
       ('Campina das Missões', '4303707', 'RS'),
       ('Campinas do Sul', '4303806', 'RS'),
       ('Campo Bom', '4303905', 'RS'),
       ('Campo Novo', '4304002', 'RS'),
       ('Campos Borges', '4304101', 'RS'),
       ('Candelária', '4304200', 'RS'),
       ('Cândido Godói', '4304309', 'RS'),
       ('Candiota', '4304358', 'RS'),
       ('Canela', '4304408', 'RS'),
       ('Canguçu', '4304507', 'RS'),
       ('Canoas', '4304606', 'RS'),
       ('Canudos do Vale', '4304614', 'RS'),
       ('Capão Bonito do Sul', '4304622', 'RS'),
       ('Capão da Canoa', '4304630', 'RS'),
       ('Capão do Cipó', '4304655', 'RS'),
       ('Capão do Leão', '4304663', 'RS'),
       ...
       ('Dois Irmãos', '4306403', 'RS'),
       ('Dois Irmãos das Missões', '4306429', 'RS'),
       ('Dois Lajeados', '4306452', 'RS'),
       ('Dom Feliciano', '4306502', 'RS'),
       ('Dom Pedrito', '4306601', 'RS'),
       ('Dom Pedro de Alcântara', '4306551', 'RS'),
       ('Dona Francisca', '4306700', 'RS'),
       ('Doutor Maurício Cardoso', '4306734', 'RS'),
       ...
       ('Esperança do Sul', '4307450', 'RS'),
       ('Espumoso', '4307500', 'RS'),
       ('Estação', '4307559', 'RS'),
       ('Estância Velha', '4307609', 'RS'),
       ('Esteio', '4307708', 'RS'),
       ('Estrela', '4307807', 'RS'),
       ('Estrela Velha', '4307815', 'RS'),
       ('Eugênio de Castro', '4307831', 'RS'),
       ...
       ('Gaurama', '4308706', 'RS'),
       ('General Câmara', '4308805', 'RS'),
       ('Gentil', '4308854', 'RS'),
       ('Getúlio Vargas', '4308904', 'RS'),
       ('Giruá', '4309001', 'RS'),
       ('Glorinha', '4309050', 'RS'),
       ('Gramado', '4309100', 'RS'),
       ...
       ('Guaíba', '4309308', 'RS'),
       ('Guaporé', '4309407', 'RS'),
       ('Guarani das Missões', '4309506', 'RS'),
       ('Harmonia', '4309555', 'RS'),
       ('Herval', '4307104', 'RS'),
       ...
       ('Jari', '4311130', 'RS'),
       ('Jóia', '4311155', 'RS'),
       ('Júlio de Castilhos', '4311205', 'RS'),
       ('Lagoa Bonita do Sul', '4311239', 'RS'),
       ('Lagoa dos Três Cantos', '4311270', 'RS'),
       ...
       ('Muçum', '4312609', 'RS'),
       ('Muitos Capões', '4312617', 'RS'),
       ('Muliterno', '4312625', 'RS'),
       ('Não-Me-Toque', '4312658', 'RS'),
       ('Nicolau Vergueiro', '4312674', 'RS'),
       ('Nonoai', '4312708', 'RS'),
       ('Nova Alvorada', '4312757', 'RS'),
       ('Nova Araçá', '4312807', 'RS'),
       ('Nova Bassano', '4312906', 'RS'),
       ('Nova Boa Vista', '4312955', 'RS'),
       ('Nova Bréscia', '4313003', 'RS'),
       ('Nova Candelária', '4313011', 'RS'),
       ('Nova Esperança do Sul', '4313037', 'RS'),
       ('Nova Hartz', '4313060', 'RS'),
       ('Nova Pádua', '4313086', 'RS'),
       ('Nova Palma', '4313102', 'RS'),
       ('Nova Petrópolis', '4313201', 'RS'),
       ...
       ('Palmeira das Missões', '4313706', 'RS'),
       ('Palmitinho', '4313805', 'RS'),
       ('Panambi', '4313904', 'RS'),
       ('Pantano Grande', '4313953', 'RS'),
       ('Paraí', '4314001', 'RS'),
       ('Paraíso do Sul', '4314027', 'RS'),
       ...
       ('Pedro Osório', '4314209', 'RS'),
       ('Pejuçara', '4314308', 'RS'),
       ('Pelotas', '4314407', 'RS'),
       ('Picada Café', '4314423', 'RS'),
       ('Pinhal', '4314456', 'RS'),
       ...
       ('Rosário do Sul', '4316402', 'RS'),
       ('Sagrada Família', '4316428', 'RS'),
       ('Saldanha Marinho', '4316436', 'RS'),
       ('Salto do Jacuí', '4316451', 'RS'),
       ('Salvador das Missões', '4316477', 'RS'),
       ('Salvador do Sul', '4316501', 'RS'),
       ('Sananduva', '4316600', 'RS'),
       ('Santa Bárbara do Sul', '4316709', 'RS'),
       ('Santa Cecília do Sul', '4316733', 'RS'),
       ...
       ('Santa Vitória do Palmar', '4317301', 'RS'),
       ('Santana da Boa Vista', '4317004', 'RS'),
       ('Sant''Ana do Livramento', '4317103', 'RS'),
       ('Santiago', '4317400', 'RS'),
       ('Santo Ângelo', '4317509', 'RS'),
       ('Santo Antônio da Patrulha', '4317608', 'RS'),
       ('Santo Antônio das Missões', '4317707', 'RS'),
       ('Santo Antônio do Palma', '4317558', 'RS'),
       ('Santo Antônio do Planalto', '4317756', 'RS'),
       ('Santo Augusto', '4317806', 'RS'),
       ('Santo Cristo', '4317905', 'RS'),
       ('Santo Expedito do Sul', '4317954', 'RS'),
       ('São Borja', '4318002', 'RS'),
       ('São Domingos do Sul', '4318051', 'RS'),
       ('São Francisco de Assis', '4318101', 'RS'),
       ('São Francisco de Paula', '4318200', 'RS'),
       ('São Gabriel', '4318309', 'RS'),
       ('São Jerônimo', '4318408', 'RS'),
       ('São João da Urtiga', '4318424', 'RS'),
       ('São João do Polêsine', '4318432', 'RS'),
       ('São Jorge', '4318440', 'RS'),
       ('São José das Missões', '4318457', 'RS'),
       ('São José do Herval', '4318465', 'RS'),
       ('São José do Hortêncio', '4318481', 'RS'),
       ('São José do Inhacorá', '4318499', 'RS'),
       ('São José do Norte', '4318507', 'RS'),
       ('São José do Ouro', '4318606', 'RS'),
       ('São José do Sul', '4318614', 'RS'),
       ('São José dos Ausentes', '4318622', 'RS'),
       ('São Leopoldo', '4318705', 'RS'),
       ('São Lourenço do Sul', '4318804', 'RS'),
       ('São Luiz Gonzaga', '4318903', 'RS'),
       ('São Marcos', '4319000', 'RS'),
       ('São Martinho', '4319109', 'RS'),
       ('São Martinho da Serra', '4319125', 'RS'),
       ('São Miguel das Missões', '4319158', 'RS'),
       ('São Nicolau', '4319208', 'RS'),
       ('São Paulo das Missões', '4319307', 'RS'),
       ('São Pedro da Serra', '4319356', 'RS'),
       ('São Pedro das Missões', '4319364', 'RS'),
       ('São Pedro do Butiá', '4319372', 'RS'),
       ('São Pedro do Sul', '4319406', 'RS'),
       ('São Sebastião do Caí', '4319505', 'RS'),
       ('São Sepé', '4319604', 'RS'),
       ('São Valentim', '4319703', 'RS'),
       ('São Valentim do Sul', '4319711', 'RS'),
       ('São Valério do Sul', '4319737', 'RS'),
       ('São Vendelino', '4319752', 'RS'),
       ('São Vicente do Sul', '4319802', 'RS'),
       ...
       ('Serafina Corrêa', '4320404', 'RS'),
       ('Sério', '4320453', 'RS'),
       ('Sertão', '4320503', 'RS'),
       ('Sertão Santana', '4320552', 'RS'),
       ...
       ('Toropi', '4321493', 'RS'),
       ('Torres', '4321501', 'RS'),
       ('Tramandaí', '4321600', 'RS'),
       ('Travesseiro', '4321626', 'RS'),
       ('Três Arroios', '4321634', 'RS'),
       ('Três Cachoeiras', '4321667', 'RS'),
       ('Três Coroas', '4321709', 'RS'),
       ('Três de Maio', '4321808', 'RS'),
       ('Três Forquilhas', '4321832', 'RS'),
       ('Três Palmeiras', '4321857', 'RS'),
       ('Três Passos', '4321907', 'RS'),
       ('Trindade do Sul', '4321956', 'RS'),
       ('Triunfo', '4322004', 'RS'),
       ('Tucunduva', '4322103', 'RS'),
       ('Tunas', '4322152', 'RS'),
       ('Tupanci do Sul', '4322186', 'RS'),
       ('Tupanciretã', '4322202', 'RS'),
       ('Tupandi', '4322251', 'RS'),
       ('Tuparendi', '4322301', 'RS'),
       ('Turuçu', '4322327', 'RS'),
       ('Ubiretama', '4322343', 'RS'),
       ('União da Serra', '4322350', 'RS'),
       ...
       ('Vanini', '4322558', 'RS'),
       ('Venâncio Aires', '4322608', 'RS'),
       ('Vera Cruz', '4322707', 'RS'),
       ('Veranópolis', '4322806', 'RS'),
       ('Vespasiano Corrêa', '4322855', 'RS'),
       ('Viadutos', '4322905', 'RS'),
       ('Viamão', '4323002', 'RS'),
       ('Vicente Dutra', '4323101', 'RS'),
       ('Victor Graeff', '4323200', 'RS'),
       ('Vila Flores', '4323309', 'RS'),
       ('Vila Lângaro', '4323358', 'RS'),
       ('Vila Maria', '4323408', 'RS'),
       ('Vila Nova do Sul', '4323457', 'RS'),
       ('Vista Alegre', '4323507', 'RS'),
       ('Vista Alegre do Prata', '4323606', 'RS'),
       ('Vista Gaúcha', '4323705', 'RS'),
       ('Vitória das Missões', '4323754', 'RS'),
       ('Westfália', '4323770', 'RS'),
       ('Xangri-lá', '4323804', 'RS'),
       ('Água Clara', '5000203', 'MS'),
       ('Alcinópolis', '5000252', 'MS'),
       ('Amambai', '5000609', 'MS'),
       ('Anastácio', '5000708', 'MS'),
       ('Anaurilândia', '5000807', 'MS'),
       ('Angélica', '5000856', 'MS'),
       ('Antônio João', '5000906', 'MS'),
       ('Aparecida do Taboado', '5001003', 'MS'),
       ('Aquidauana', '5001102', 'MS'),
       ('Aral Moreira', '5001243', 'MS'),
       ('Bandeirantes', '5001508', 'MS'),
       ('Bataguassu', '5001904', 'MS'),
       ('Batayporã', '5002001', 'MS'),
       ('Bela Vista', '5002100', 'MS'),
       ('Bodoquena', '5002159', 'MS'),
       ('Bonito', '5002209', 'MS'),
       ('Brasilândia', '5002308', 'MS'),
       ('Caarapó', '5002407', 'MS'),
       ('Camapuã', '5002605', 'MS'),
       ('Campo Grande', '5002704', 'MS'),
       ('Caracol', '5002803', 'MS'),
       ('Cassilândia', '5002902', 'MS'),
       ('Chapadão do Sul', '5002951', 'MS'),
       ('Corguinho', '5003108', 'MS'),
       ('Coronel Sapucaia', '5003157', 'MS'),
       ('Corumbá', '5003207', 'MS'),
       ('Costa Rica', '5003256', 'MS'),
       ('Coxim', '5003306', 'MS'),
       ('Deodápolis', '5003454', 'MS'),
       ('Dois Irmãos do Buriti', '5003488', 'MS'),
       ('Douradina', '5003504', 'MS'),
       ('Dourados', '5003702', 'MS'),
       ('Eldorado', '5003751', 'MS'),
       ('Fátima do Sul', '5003801', 'MS'),
       ('Figueirão', '5003900', 'MS'),
       ('Glória de Dourados', '5004007', 'MS'),
       ('Guia Lopes da Laguna', '5004106', 'MS'),
       ('Iguatemi', '5004304', 'MS'),
       ('Inocência', '5004403', 'MS'),
       ('Itaporã', '5004502', 'MS'),
       ('Itaquiraí', '5004601', 'MS'),
       ('Ivinhema', '5004700', 'MS'),
       ('Japorã', '5004809', 'MS'),
       ...
       ('São Gabriel do Oeste', '5007695', 'MS'),
       ('Selvíria', '5007802', 'MS'),
       ('Sete Quedas', '5007703', 'MS'),
       ('Sidrolândia', '5007901', 'MS'),
       ('Sonora', '5007935', 'MS'),
       ('Tacuru', '5007950', 'MS'),
       ('Taquarussu', '5007976', 'MS'),
       ('Terenos', '5008008', 'MS'),
       ('Três Lagoas', '5008305', 'MS'),
       ...
       ('Boa Esperança do Norte', '5101837', 'MT'),
       ...
       ('Santo Antônio de Leverger', '5107800', 'MT'),
       ...
       ('Leopoldo de Bulhões', '5212303', 'GO'),
       ('Luziânia', '5212501', 'GO'),
